          ...
          <table className="w-full">
            <thead className="bg-zinc-50 border-b">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-zinc-500 uppercase">Tanggal</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-zinc-500 uppercase">Deskripsi</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-zinc-500 uppercase">Kategori</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-zinc-500 uppercase">Tipe</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-zinc-500 uppercase">Jumlah</th>
            ...
            <tbody className="divide-y divide-zinc-200">
              {transactions.slice(0, 20).map((transaction) => (
                <tr key={transaction.id} className="hover:bg-zinc-50">
                  <td className="px-4 py-3 text-sm font-medium text-zinc-900">{transaction.id}</td>
                  <td className="px-4 py-3 text-sm text-zinc-600">{formatDate(transaction.date)}</td>
                  <td className="px-4 py-3 text-sm text-zinc-900">{transaction.description}</td>
                  <td className="px-4 py-3 text-sm text-zinc-600">{transaction.category}</td>
